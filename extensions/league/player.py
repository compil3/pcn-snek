            ...
            try:
                ...
                if display is not None:
                    try:
                        ...
                        paginator = Paginator.create_from_embeds(self.bot, *display, timeout=45)
                    ...
                    await ctx.send(
                        f"Unable to retreive stats for {gamertag}.  Please check the tag and try again."
                    )
                    return
            except Exception as e:
                logging.ERROR(e)
